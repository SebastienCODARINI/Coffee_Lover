...
class __TwigTemplate_9ca128e8fe41aab0645c18be15e706be35c80166e59240d3349922e2d8da4ac1 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div>
      <h1>Erreur 404 - Chalut! Je finis mon café et je reviens</h1>
      <img src=\"";
        // line 6
...
{% block body %}
  <div class=\"container text-center\">
    <div>
      <h1>Erreur 404 - Chalut! Je finis mon café et je reviens</h1>
      <img src=\"{{ asset('images/404.png') }}\" class=\"d-block mx-auto mb-2\" width=\"500px\" height=\"500px\" alt=\"Erreur 500\" />
      <p>Une erreur interne s'est produite. Nous nous efforçons de résoudre ce problème.</p>
    </div>
    <div class=\"d-flex justify-content-center align-items-center\">
...
{% endblock %}
", "@Twig/Exception/error404.html.twig", "/var/www/html/projet-12-coffee-lover/templates/bundles/TwigBundle/Exception/error404.html.twig");
    }
}
