...
class __TwigTemplate_395a116e073b1622730c58a5ff4d7a21ca054a0c5f85f876868963d3ee7c9500 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "back-office/user/list.html.twig"));
        ...
        $this->parent = $this->loadTemplate("back-office/base.html.twig", "back-office/user/list.html.twig", 1);
 ...
 <div class=\"container center mb-5\" style=\"max-width: 40rem;\">
    <section class=\"features-section px-1 mb-4\">
      <div class=\"container-fluid mx-auto\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "</td>
                <td>
                  <a href=\"";
            // line 26
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_back_users_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 26)]), "html", null, true);
            echo "\" class=\"btn btn-rounded btn-quiz bi bi-pencil m-2\"></a>
                  ";
            // line 27
            $this->loadTemplate("fragments/_confirm_action.html.twig", "back-office/user/list.html.twig", 27)->display(twig_array_merge($context, ["confirmationMessage" => "Voulez-vous vraiment supprimer ?", "actionUrl" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_back_users_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 27)]), "buttonLabel" => ""]));
            // line 28
            echo "                </td>
              </tr>
            ";
        ...
        // line 33
        echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->render($this->env, (isset($context["users"]) || array_key_exists("users", $context) ? $context["users"] : (function () { throw new RuntimeError('Variable "users" does not exist.', 33, $this->source); })()));
        echo "</div>
        ";
        // line 35
        echo "      </div>
...
";
    ...
    {
        return array (  163 => 35,  159 => 33,  155 => 31,  139 => 28,  137 => 27,  133 => 26,  126 => 24,  123 => 23,  106 => 22,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "back-office/user/list.html.twig", "/var/www/html/projet-12-coffee-lover/templates/back-office/user/list.html.twig");
    }
}
