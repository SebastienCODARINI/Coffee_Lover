...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\BackOffice\\ArticleBackOfficeController' => 'getArticleBackOfficeControllerService',
            'App\\Controller\\BackOffice\\BackOfficeController' => 'getBackOfficeControllerService',
            'App\\Controller\\BackOffice\\GifBackOfficeController' => 'getGifBackOfficeControllerService',
            'App\\Controller\\BackOffice\\QuizBackOfficeController' => 'getQuizBackOfficeControllerService',
            'App\\Controller\\BackOffice\\RewardBackOfficeController' => 'getRewardBackOfficeControllerService',
            'App\\Controller\\BackOffice\\UserBackOfficeController' => 'getUserBackOfficeControllerService',
            'App\\Controller\\FrontOffice\\ArticleController' => 'getArticleControllerService',
            'App\\Controller\\FrontOffice\\MainController' => 'getMainControllerService',
            'App\\Controller\\FrontOffice\\QuizController' => 'getQuizControllerService',
            'App\\Controller\\FrontOffice\\UserController' => 'getUserControllerService',
            'App\\Controller\\SecurityController' => 'getSecurityControllerService',
            'App\\Naming\\CustomNamer' => 'getCustomNamerService',
            'App\\Naming\\CustomNamer.article_images' => 'getCustomNamer_ArticleImagesService',
            'App\\Naming\\CustomNamer.gif_images' => 'getCustomNamer_GifImagesService',
            'App\\Naming\\CustomNamer.reward_images' => 'getCustomNamer_RewardImagesService',
            'App\\Naming\\CustomNamerSoundstrack' => 'getCustomNamerSoundstrackService',
            'App\\Naming\\CustomNamerSoundstrack.soundstrack_images' => 'getCustomNamerSoundstrack_SoundstrackImagesService',
    ...
    protected function get_Container_Private_TwigService()
    {
        ...
        $instance->addGlobal('cdn_base_url', $this->getEnv('CDN_BASE_URL'));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('UiYagrBHkA', 0, ($this->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('omPgGArJNF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\GifRepository' => ['privates', 'App\\Repository\\GifRepository', 'getGifRepositoryService', true],
            'App\\Repository\\PlayRepository' => ['privates', 'App\\Repository\\PlayRepository', 'getPlayRepositoryService', true],
            ...
            'App\\Repository\\RewardRepository' => ['privates', 'App\\Repository\\RewardRepository', 'getRewardRepositoryService', true],
            ...
            'App\\Repository\\RewardRepository' => '?',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('knp_pager.items', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\PaginationSubscriber'] ?? ($this->privates['App\\EventSubscriber\\PaginationSubscriber'] = new \App\EventSubscriber\PaginationSubscriber()));
        }, 1 => 'items'], 1);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('v5qKHPept1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('h7C+Vg2qKB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XeZ-c-cQIR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('S7GShF8TIS', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5usQkNnBdT', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnection_EventManagerService()
    {
        return $this->privates['doctrine.dbal.default_connection.event_manager'] = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'vich_uploader.listener.clean.gif_images' => ['privates', 'vich_uploader.listener.clean.gif_images', 'getVichUploader_Listener_Clean_GifImagesService', true],
            'vich_uploader.listener.clean.reward_images' => ['privates', 'vich_uploader.listener.clean.reward_images', 'getVichUploader_Listener_Clean_RewardImagesService', true],
            'vich_uploader.listener.clean.soundstrack_images' => ['privates', 'vich_uploader.listener.clean.soundstrack_images', 'getVichUploader_Listener_Clean_SoundstrackImagesService', true],
            ...
            'vich_uploader.listener.remove.gif_images' => ['privates', 'vich_uploader.listener.remove.gif_images', 'getVichUploader_Listener_Remove_GifImagesService', true],
            'vich_uploader.listener.remove.reward_images' => ['privates', 'vich_uploader.listener.remove.reward_images', 'getVichUploader_Listener_Remove_RewardImagesService', true],
            'vich_uploader.listener.remove.soundstrack_images' => ['privates', 'vich_uploader.listener.remove.soundstrack_images', 'getVichUploader_Listener_Remove_SoundstrackImagesService', true],
            ...
            'vich_uploader.listener.upload.gif_images' => ['privates', 'vich_uploader.listener.upload.gif_images', 'getVichUploader_Listener_Upload_GifImagesService', true],
            'vich_uploader.listener.upload.reward_images' => ['privates', 'vich_uploader.listener.upload.reward_images', 'getVichUploader_Listener_Upload_RewardImagesService', true],
            'vich_uploader.listener.upload.soundstrack_images' => ['privates', 'vich_uploader.listener.upload.soundstrack_images', 'getVichUploader_Listener_Upload_SoundstrackImagesService', true],
        ], [
            ...
            'vich_uploader.listener.clean.gif_images' => '?',
            'vich_uploader.listener.clean.reward_images' => '?',
            'vich_uploader.listener.clean.soundstrack_images' => '?',
            'vich_uploader.listener.remove.article_images' => '?',
            'vich_uploader.listener.remove.gif_images' => '?',
            'vich_uploader.listener.remove.reward_images' => '?',
            'vich_uploader.listener.remove.soundstrack_images' => '?',
            'vich_uploader.listener.upload.article_images' => '?',
            'vich_uploader.listener.upload.gif_images' => '?',
            'vich_uploader.listener.upload.reward_images' => '?',
            'vich_uploader.listener.upload.soundstrack_images' => '?',
        ]), [0 => 'vich_uploader.listener.clean.reward_images', 1 => 'vich_uploader.listener.clean.gif_images', 2 => 'vich_uploader.listener.clean.soundstrack_images', 3 => 'vich_uploader.listener.clean.article_images', 4 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 5 => 'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber', 6 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 7 => 'vich_uploader.listener.remove.reward_images', 8 => 'vich_uploader.listener.upload.reward_images', 9 => 'vich_uploader.listener.remove.gif_images', 10 => 'vich_uploader.listener.upload.gif_images', 11 => 'vich_uploader.listener.remove.soundstrack_images', 12 => 'vich_uploader.listener.upload.soundstrack_images', 13 => 'vich_uploader.listener.remove.article_images', 14 => 'vich_uploader.listener.upload.article_images', 15 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]);
    }
    ...
    {
        return $this->privates['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(['defaultPaginationTemplate' => '@KnpPaginator/Pagination/materialize_pagination.html.twig', 'defaultSortableTemplate' => '@KnpPaginator/Pagination/twitter_bootstrap_v3_sortable_link.html.twig', 'defaultFiltrationTemplate' => '@KnpPaginator/Pagination/bootstrap_v5_filtration.html.twig', 'defaultPageRange' => 2, 'defaultPageLimit' => NULL]);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'vich_uploader.mappings' => [
                'reward_images' => [
                    'uri_prefix' => '/images/rewards',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/rewards'),
                    'namer' => [
                        'service' => 'App\\Naming\\CustomNamer.reward_images',
                        'options' => [
                ...
                'gif_images' => [
                    'uri_prefix' => '/images/gifs',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/gifs'),
                    'namer' => [
                        'service' => 'App\\Naming\\CustomNamer.gif_images',
                        'options' => [
                ...
                'soundstrack_images' => [
                    'uri_prefix' => '/images/soundstracks',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/soundstracks'),
                    'namer' => [
                        'service' => 'App\\Naming\\CustomNamerSoundstrack.soundstrack_images',
                        'options' => [
                ...
                'article_images' => [
                    ...
                    'namer' => [
                        'service' => 'App\\Naming\\CustomNamer.article_images',
                        'options' => [
            ...
            'knp_paginator.template.pagination' => '@KnpPaginator/Pagination/materialize_pagination.html.twig',
