...
class __TwigTemplate_e0138ccc342d44eae2dbca79137e47d57924eafdd7215132e437c0c290f7690d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div>
      <h1>Erreur 403 - Chat alors! Vous n'avez pas le droit d'être ici petit chanaillou</h1>
      <img src=\"";
        // line 6
...
{% block body %}
  <div class=\"container text-center\">
    <div>
      <h1>Erreur 403 - Chat alors! Vous n'avez pas le droit d'être ici petit chanaillou</h1>
      <img src=\"{{ asset('images/403.png') }}\" class=\"d-block mx-auto mb-2\" width=\"500px\" height=\"500px\" alt=\"Erreur 500\" />
...
{% endblock %}
", "@Twig/Exception/error403.html.twig", "/var/www/html/projet-12-coffee-lover/templates/bundles/TwigBundle/Exception/error403.html.twig");
    }
}
