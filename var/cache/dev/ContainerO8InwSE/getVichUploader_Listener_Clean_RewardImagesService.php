 ...
 */
class getVichUploader_Listener_Clean_RewardImagesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.reward_images' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.reward_images'])) {
            return $container->privates['vich_uploader.listener.clean.reward_images'];
        }

        return $container->privates['vich_uploader.listener.clean.reward_images'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('reward_images', ($container->privates['vich_uploader.adapter.orm'] ?? ($container->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($container->privates['vich_uploader.metadata_reader'] ?? $container->getVichUploader_MetadataReaderService()), $a);
    }
}
